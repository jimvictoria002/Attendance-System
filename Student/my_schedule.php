    ...
    <div class="sched-main">
        ...
        <table>
            <tbody>
                ...
                echo"<tr>";
                echo "<th>{$day}</th>";
                $sql = "SELECT * FROM `subjects_sched` INNER JOIN subjects ON subjects_sched.sub_id = subjects.sub_id INNER JOIN teachers ON subjects.teachers_id = teachers.teachers_id WHERE subjects.course = '{$_SESSION['course']}' AND subjects.year_level = {$_SESSION['year_level']} AND subjects.section = '{$_SESSION['section']}' AND subjects_sched.weeks = '{$day}' ORDER BY STR_TO_DATE(subjects_sched.start_time, '%h:%i %p')";
                ...
                ?>
                    <td style="white-space: nowrap;">
                        ...
                        <p class="intructor"><?php echo"{$row['teachers_firstname'][0]}. {$row['teachers_lastname']}";?></p>
                    </td>
                <?php
                }
                echo"<tr>";
